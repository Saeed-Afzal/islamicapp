...
class _UpdateState extends State<Update> {
  ...
  final Query<Map<String, dynamic>> _products =
      FirebaseFirestore.instance.collection('examdetails').where('status', isEqualTo: 'pending');
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      // keyboardType: TextInputType.numberWithOptions(decimal: true),
                      decoration:
                          InputDecoration(labelText: 'Exam Duration Time'),
                    ),
                    TextField(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Approve Exam Registration"),
        backgroundColor: Colors.red,
      ),
      body: StreamBuilder(
