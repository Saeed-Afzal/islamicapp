...
class ZikrOAskaar extends StatefulWidget {
  const ZikrOAskaar({Key? key}) : super(key: key);

  @override
  State<ZikrOAskaar> createState() => _ZikrOAskaarState();
}

class _ZikrOAskaarState extends State<ZikrOAskaar> {
  //video
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
        "https://firebasestorage.googleapis.com/v0/b/islamic-app-e6a18.appspot.com/o/videos%2Fzikr1.mp4?alt=media&token=a1f5dddc-f304-4747-9a71-c5db12c6d74e");
