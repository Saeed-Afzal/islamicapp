...
class ZikrOAskaar2 extends StatefulWidget {
  const ZikrOAskaar2({Key? key}) : super(key: key);

  @override
  State<ZikrOAskaar2> createState() => _ZikrOAskaar2State();
}

class _ZikrOAskaar2State extends State<ZikrOAskaar2> {
  //video
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
        "https://firebasestorage.googleapis.com/v0/b/islamic-app-e6a18.appspot.com/o/videos%2Fzikr2.mp4?alt=media&token=a97a7448-97e9-42c2-b87d-3a1fbb80ea9c");
